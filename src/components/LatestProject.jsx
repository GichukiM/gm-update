...
import miricoImage from '../assets/Macbook-Air-mirico-ri-coli.vercel.app.png'

const MyLatestWork = () => {
  return (
    <section id='projects' className="relative overflow-hidden px-6 py-16 sm:py-32 lg:px-8">
      ...
      <div className="max-w-screen-xl container mx-auto flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 space-y-6 md:pl-8">
          ...
          <div className="space-y-4 text-lg text-gray-600">
            ...
            <p><strong>Current Status:</strong> The project is actively being developed, with ongoing work on finalizing features and optimizing performance. See initial prototypes and designs <a href="https://mirico-ri-coli.vercel.app/" target="_blank" 
                rel="noopener noreferrer" 
                className="text-[#d4af37] items-center">here</a>, and I am working towards completing the remaining tasks to deliver a polished and functional e-commerce platform.</p>
          </div>
        </div>
