const WorkExperience = () => {
  return (
    <section id="experience" className="py-12 px-6 sm:px-12 lg:px-16">
      ...
      <div className="max-w-screen-xl mx-auto space-y-8">
        ...
        <div className="p-6 rounded-lg shadow-md">
          ...
          <p className="text-white mb-4">
            ...
            skills through practical projects. During this 4-week internship, I
          ...
          <ul className="list-disc pl-6 text-white space-y-2 mb-4">
            <li>
              ...
              records.
              {" "} <a className="text-[#d4af37] hover:text-white" href="https://jinasave-frontend.onrender.com/">Live Link</a>
            </li>
            <li>
              <strong>CalcHub:</strong> Built a multi-functional calculator app
              featuring compound interest, currency conversion (using the
              ExchangeRate API), and loan payment calculators.
              {" "} <a className="text-[#d4af37] hover:text-white" href="https://ubuntu-calc-hub-frontend.onrender.com/">Live Link</a>
            </li>
            <li>
              ...
              {" "} <a className="text-[#d4af37] hover:text-white" href="https://rock-paper-scissors-sx38.onrender.com/">Live Link</a>
            </li>
            <li>
              <strong>SecurePass:</strong> Designed a secure password generator
              with email verification for sign-ups, logins, and password
              recovery, emphasizing user security.
              {" "} <a className="text-[#d4af37] hover:text-white" href="https://go2cod-sd-03.onrender.com/signup">Live Link</a>
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 text-white space-y-2">
            <li>
              Developed projects using the MERN stack (MongoDB, Express, React,
              Node.js), integrating external APIs to build scalable,
